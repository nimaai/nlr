...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var jQuery, navigate, registerNav, update;

	global.index = null;

	update = __webpack_require__(1);

	navigate = __webpack_require__(35);
	...
	jQuery(function() {
	  ...
	  return setInterval(update.updateCurrentLila, 1000);
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {var nlr, updateCurrentTime, updateLilaInformation, updateLilaProgress;

	nlr = __webpack_require__(2);

	updateCurrentTime = function(currentHour, currentMinute) {
	  return global.document.getElementById('current-time').innerHTML = nlr.time.formatTime(currentHour, currentMinute);
	};

	updateLilaInformation = function(index) {
	  ...
	  return global.document.getElementById('long-description').innerHTML = nlr.getLongDescription(index).join('<br><br>');
	};

	updateLilaProgress = function(d) {
	  var lilaProgress, procent;
	  ...
	  return lilaProgress.setAttribute('style', 'width: ' + procent + '%;');
	};

	exports.updateLila = function() {
	  return updateLilaInformation(index);
	};

	exports.updateCurrentLila = function() {
	  var currentDate, currentHour, currentMinute, i;
	  ...
	  if (i !== index) {
	    global.index = i;
	    return updateLilaInformation(i);
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	timeIntervals = __webpack_require__(3);

	sanskritNames = __webpack_require__(4);

	englishNames = __webpack_require__(5);

	shortDescriptions = __webpack_require__(6);

	rupaDescriptions = __webpack_require__(7);

	vishvanathDescriptions = __webpack_require__(8);

	longDescriptions = [];

	longDescriptions[0] = __webpack_require__(9);

	longDescriptions[1] = __webpack_require__(10);

	longDescriptions[2] = __webpack_require__(11);

	longDescriptions[3] = __webpack_require__(12);

	longDescriptions[4] = __webpack_require__(13);

	longDescriptions[5] = __webpack_require__(14);

	longDescriptions[6] = __webpack_require__(15);

	longDescriptions[7] = __webpack_require__(16);

	module.exports = {
	  getLilaIndex: __webpack_require__(17).getLilaIndex,
	  getLilaProgress: __webpack_require__(19).getLilaProgress,
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getLilaIndex = function(d) {
	  ...
	  timeIntervals = __webpack_require__(3);
	  getDayTimeInMinutes = __webpack_require__(18).getDayTimeInMinutes;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getLilaProgress = function(d) {
	  ...
	  timeIntervals = __webpack_require__(3);
	  getDayTimeInMinutes = __webpack_require__(18).getDayTimeInMinutes;
	  i = __webpack_require__(17).getLilaIndex(d);
	  bh = timeIntervals[i][0][0];
	  bm = timeIntervals[i][0][1];
	  eh = timeIntervals[i][1][0];
	  em = timeIntervals[i][1][1];
...
/***/ function(module, exports) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {exports.forward = function() {
	  var index;
	  if (index = 0) {
	    return global.index = 7;
	  } else {
